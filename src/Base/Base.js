...
export default function Base({ children }) {
  ...
  return (
    <div className="h-screen w-screen overflow-hidden hide-scrollbar">
      <div className="sticky top-2.5 mx-5 my-0">
        <Topbar />
      </div>
      <div className="mx-1 lg:mx-4 xl:mx-5 md:mx-3 overflow-hidden overflow-x-hidden hide-scrollbar mb-40 mt-5 xl:mb-10 lg:mb-10">
        {children}
      </div>
